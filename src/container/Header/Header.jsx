...
const Header = () => (
	<div className='app__header app__flex'>
			...
			<div className='app__header-badge'>
				<div className='badge-cmp app__flex'>
					...
					<div style={{ marginLeft: 20 }}>
						<p className='p-text'>Привет! Меня зовут</p>
						<h1 className='head-text'>Вадим</h1>
					</div>
				</div>

				<div className='tag-cmp app__flex'>
					<p className='p-text'>Веб-Разработчик</p>
					<p className='p-text'>HTML-верстальщик</p>
				</div>
			</div>
		</motion.div>
		...
		<motion.div variants={scaleVariants} whileInView={scaleVariants.whileInView} className='app__header-circles'>
			{[images.node, images.redux, images.typescript].map((circle, index) => (
